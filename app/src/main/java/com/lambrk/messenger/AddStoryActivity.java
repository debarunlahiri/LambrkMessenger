...
public class AddStoryActivity extends AppCompatActivity {
    ...
    private TextView tvAddStory, tvAddStoryChangeImage, tvAddStoryCropImage, tvAddStoryBody, tvAddStoryDone;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvAddStoryDone = findViewById(R.id.tvAddStoryDone);
        ...
        tvAddStoryDone.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (tvAddStoryDone.equals("Cancel")) {
                    onBackPressed();
                }
            }
        });
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE) {
            ...
            if (resultCode == RESULT_OK) {
                ...
                if (postImageUri == null) {
                    addstorybottomCV.setVisibility(View.INVISIBLE);
                    addstorytopCV.setVisibility(View.VISIBLE);
                    tvAddStoryDone.setText("Cancel");
                } else {
                    addstorybottomCV.setVisibility(View.VISIBLE);
                    tvAddStoryDone.setText("Done");
                }
