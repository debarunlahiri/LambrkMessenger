    ...
    private void initPopupMenu(ViewHolder holder, int position) {
        ...
        popupMenu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem menuItem) {
                if (menuItem.getItemId() == R.id.message_reply_item) {
                ...
                } else if (menuItem.getItemId() == R.id.message_edit_item) {
                ...
                } else if (menuItem.getItemId() == R.id.message_delete_item) {
                    ...
                    builder.show();
                } else if (menuItem.getItemId() == R.id.message_delete_for_everyone_item) {
                    ...
                    builder1.show();
                } else if (menuItem.getItemId() == R.id.message_copy_item) {
