...
import com.lambrk.messenger.Explore.ExploreFragment;
import com.lambrk.messenger.Group.GroupFragment;
import com.lambrk.messenger.Inbox.InboxFragment;
import com.lambrk.messenger.SetupUser.SetupActivity;
import com.lambrk.messenger.Shortcuts.ShortcutsFragment;
import com.lambrk.messenger.Stories.StoriesFragment;
    ...
    private void beginFragmentTransaction() {
        ...
        bottomNavigationView.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                if (item.getItemId() == R.id.home_home_menu_list_item) {
                    fragmentManager.beginTransaction().hide(active[0]).show(inboxFragment).commit();
                    active[0] = inboxFragment;
                } else if (item.getItemId() == R.id.group_home_menu_list_item) {
                    fragmentManager.beginTransaction().hide(active[0]).show(groupFragment).commit();
                    active[0] = groupFragment;
                } else if (item.getItemId() == R.id.explore_home_menu_list_item) {
                    fragmentManager.beginTransaction().hide(active[0]).show(exploreFragment).commit();
                    active[0] = exploreFragment;
                } else if (item.getItemId() == R.id.shortcuts_home_menu_list_item) {
