...
public class SetupUser2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setupuser2nextbutton.setBackgroundResource(R.drawable.blue_button);
        setupuser2nextbutton.setTextColor(Color.WHITE);
        setupuser2nextbutton.setText("Next");
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE) {
            ...
            if (resultCode == RESULT_OK) {
                ...
                /*
                if (profilePictureURI == null) {
                    setupuser2nextbutton.setBackgroundResource(R.drawable.secondary_button_bg);
                    setupuser2nextbutton.setTextColor(getResources().getColor(R.color.colorDeepLightBlue));
                    setupuser2nextbutton.setText("Skip");
                } else {
